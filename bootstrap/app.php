...
Dusterio\LumenPassport\LumenPassport::routes($app->router, ['prefix' => 'api/v4/oauth']);
// $app->register(Mpdf\MpdfServiceProvider::class);

#$app->register(['QrCode'=>SimpleSoftwareIO\QrCode\QrCodeServiceProvider::class);
