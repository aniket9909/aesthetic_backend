    ...
    <div class="container">
        ...
        @if ($css['letter_head'])
            <div class="header">
              @if($data['doctor']['letterhead'])
                ...
                <img src="{{ $data['doctor']['letterhead'] }}" alt="letterheadImage" 
                    width="710" />               
        ...
        {{-- <div class="patientContainer">
            <div class="patientDetails">
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 8px;">
                    ...
                    <tr>
                        <td><label>{{ $data['patient']['patient_name'] }}</label></td>
                        <td><label>{{ $data['patient']['mobile_no'] }}</label></td>
                        <td><label>{{ $data['patient']['age'] }}/{{ $data['patient']['gender'] }}</label></td>
                        <td><label>{{ $data['rx']['date'] }}</label></td>
                    </tr>
                </table>
            </div>
        </div> --}}
        ...
        <div class="patientContainer">
            <div class="patientDetails">
                ...
                <div>{{ $data['patient']['patient_name'] }}</div>
            </div>
            <div class="patientDetails">
                <label for="">Mobile number</label>
                <div>{{ $data['patient']['mobile_no'] }}</div>
            </div>
            <div class="patientDetails">
                <label for="">Age/Gender</label>
                <div>{{ $data['patient']['age'] }}/{{ $data['patient']['gender'] }}</div>
            </div>
            <div class="patientDetails">
                <label for="">Consultation date</label>
                <div>{{ $data['rx']['date'] }}</div>
            </div>
        </div>
        ...
        <div class="prescriptionDetails">
            <div class="{{ $css['prescription_template'] == 'single' ? 'single' : 'double' }}">
                @if ($data['rx']['follow_up'])
                    <div class="prescriptionDataBox">
                        <label for="">FOLLOW UP</label>
                        <div style="padding-bottom: 2px">{{ $data['rx']['follow_up'] ? $data['rx']['follow_up'] : ' ' }}
                        </div>
                    </div>
                @endif
                            ...
                            @foreach ($data['rx']['symptoms'] as $symptoms)
                                <ul>
                                    <li>
                                        {{ $symptoms['name'] }}
                                        @if($symptoms['symptoms_days'] || $symptoms['severity'])
                                        <span>({{ $symptoms['symptoms_days']}} {{$symptoms['severity'] }})</span>
                                        @endif
        ...
        {{-- <div  style="text-align: {{ $css['footer_alignment'] }}"> --}}
        <div style="text-align: {{ $css['footer_alignment'] ? $css['footer_alignment'] : 'right' }}"
            class="{{ $css['prescription_template'] == 'single' ? 'footersingle' : 'footerdouble' }}">
            @if ($css['signuture'])
                <img src="{{ $data['doctor']['sign'] }}" alt="Signature Image" style="margin-right: 13%;"
                    width="70" />
